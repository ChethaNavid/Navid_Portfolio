...
function Sidebar({
  ...
  return (
    <div
      className="fixed inset-y-0 z-10 hidden md:flex flex-col bg-sidebar text-sidebar-foreground w-(--sidebar-width)"
      data-slot="sidebar"
      {...props}
    >
      {children}
...
const SideBarProfile = () => {
  return (
    <div className="flex flex-col justify-center items-center gap-0.5 my-4">
